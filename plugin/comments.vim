...
function! CommentLine()
  ...
  " for .cpp or .hpp or .java or .C files use // /modify by hkbarton, js also comment by //
...
function! UnCommentLine()
  ...
  " for .cpp or .hpp or .java or .C files use // /edit by hkbarton, js use // also
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$' || file_name =~ '\.js$'
...
function! RangeUnCommentLine()
  ...
  " for .cpp or .hpp or .java files use // /edit by hkbarton js use // also
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$' || file_name =~ '\.js$'
